...
| 3.2.3 Motor de Turnos | en progreso | FASE-3_PROMPT-13 (TASK-80, corrección a TASK-40: cobertura de tests de la retención de 24h del turno liberado en modalidad manual, contra el servicio de disponibilidad) | backend |
