...
| 3.2.3 Motor de Turnos | en progreso | FASE-3_PROMPT-4 (regla de paciente nuevo: acepta_nuevos, solo_mayores, tope de un paciente nuevo por jornada y doble turno según la franja extra configurada) | backend |
