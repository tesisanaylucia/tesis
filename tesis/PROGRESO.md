...
| 3.2.2 Pacientes | completo (pendiente de revisión) | FASE-3_PROMPT-11 (edición de datos del paciente habilitada para el profesional tratante, acotada a sus propios pacientes) | backend |
