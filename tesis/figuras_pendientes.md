...
| 13 | Mapa de endpoints del módulo Pacientes con permisos por rol (alta, búsqueda por documento, detalle, modificación, baja lógica, vinculación con profesional, prioridad y estado de datos; alcance de administrador, proceso automatizado y profesional tratante) | 3.2.2 Pacientes | backend |
